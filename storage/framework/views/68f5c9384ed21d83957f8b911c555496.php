    ...
    <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 15px;">
        <div>
            <h1 class="page-title">
                ...
                Questions for: <?php echo e($course->title); ?>

            </h1>
            <p style="margin: 0; color: #666;">
                <span class="course-code-badge"><?php echo e($course->code); ?></span>
                - <?php echo e($questions->total()); ?> question(s)
            </p>
        </div>
    ...
    <div class="stats-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); gap: 15px; margin-bottom: 30px;">
        <div class="stat-card">
            ...
            <div class="stat-info">
                ...
                <div class="stat-value"><?php echo e($questions->total()); ?></div>
            </div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-info">
                ...
                <div class="stat-value"><?php echo e($questions->sum('points')); ?></div>
            </div>
        </div>
    </div>
            ...
            <div class="question-card">
                <div class="question-header">
                    <div class="question-meta">
                        <span class="question-number">Question #<?php echo e($questions->firstItem() + $loop->index); ?></span>
                        <span class="question-points"><?php echo e($question->points); ?> point(s)</span>
                        <span class="question-type"><?php echo e(ucfirst(str_replace('_', ' ', $question->type))); ?></span>
                    </div>
                    <div class="question-actions">
                        <a href="<?php echo e(route('admin.question-pool.edit', $question->id)); ?>" class="action-btn" title="Edit">
                            <i class="fas fa-pencil-alt"></i>
                        </a>
                        <form action="<?php echo e(route('admin.question-pool.destroy', $question->id)); ?>" method="POST" style="display: inline;" onsubmit="return confirm('Are you sure you want to delete this question?');">
                            <?php echo csrf_field(); ?>
                ...
                <div class="question-options">
                    ...
                    <div class="option-item <?php echo e($key === $question->correct_answer ? 'correct-answer' : ''); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO LEGION\Documents\leveler\resources\views/admin/question-pool/course-questions.blade.php ENDPATH**/ ?>