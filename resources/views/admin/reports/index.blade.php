    ...
    <div class="stats-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px; margin-bottom: 30px;">
        <div class="stat-card">
            ...
            <div class="stat-info">
                ...
                <div class="stat-value">{{ $stats['total_trainees'] }}</div>
            </div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-info">
                ...
                <div class="stat-value">{{ $stats['active_trainees'] }}</div>
            </div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-info">
                ...
                <div class="stat-value">{{ $stats['passed_results'] }}</div>
            </div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-info">
                ...
                <div class="stat-value">{{ $stats['failed_results'] }}</div>
            </div>
        </div>
        ...
        <div class="content-section">
            ...
            <div class="payment-stats-grid">
                <div class="payment-stat-item">
                    ...
                    <div class="payment-stat-value">₦{{ number_format($paymentStats['today'], 2) }}</div>
                </div>
                <div class="payment-stat-item">
                    <div class="payment-stat-label">This Month</div>
                    <div class="payment-stat-value">₦{{ number_format($paymentStats['this_month'], 2) }}</div>
                </div>
                <div class="payment-stat-item">
                    <div class="payment-stat-label">This Year</div>
                    <div class="payment-stat-value">₦{{ number_format($paymentStats['this_year'], 2) }}</div>
                </div>
            </div>
        </div>
            ...
            <div class="status-distribution">
                <div class="status-item">
                    ...
                    <div class="status-bar">
                        <div class="status-fill" style="width: {{ $stats['total_trainees'] > 0 ? ($traineeStatus['active'] / $stats['total_trainees']) * 100 : 0 }}%; background: #10b981;">
                ...
                <div class="status-item">
                    ...
                    <div class="status-bar">
                        <div class="status-fill" style="width: {{ $stats['total_trainees'] > 0 ? ($traineeStatus['inactive'] / $stats['total_trainees']) * 100 : 0 }}%; background: #f59e0b;">
                ...
                <div class="status-item">
                    ...
                    <div class="status-bar">
                        <div class="status-fill" style="width: {{ $stats['total_trainees'] > 0 ? ($traineeStatus['with_payment'] / $stats['total_trainees']) * 100 : 0 }}%; background: #3b82f6;">
                            {{ $traineeStatus['with_payment'] }}
                        </div>
                    </div>
                </div>
            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            ...
                            <br>
                            <small style="color: #666;">{{ $course->title }}</small>
                        </td>
                        <td>{{ $course->total_results }}</td>
                        <td>
                            <span class="badge badge-success">{{ $course->passed_results }}</span>
                        </td>
                        <td>
                            <div style="display: flex; align-items: center; gap: 10px;">
                                <div style="flex: 1; background: #e0e0e0; height: 8px; border-radius: 4px; overflow: hidden;">
                                    <div style="background: #10b981; height: 100%; width: {{ $course->pass_rate }}%;"></div>
                                </div>
                                <span style="font-weight: 600; min-width: 50px;">{{ number_format($course->pass_rate, 1) }}%</span>
                            </div>
                        </td>
                        <td>
                            <strong style="color: {{ $course->average_score >= 50 ? '#10b981' : '#ef4444' }};">
        ...
        <div class="table-container">
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $result->trainee->full_name }}</td>
