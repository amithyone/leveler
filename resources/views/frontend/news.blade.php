...
@section('title', 'News - Leveler')

@section('content')
<section class="page-header">
    <div class="container">
        <h1>{{ $page->title ?? 'News & Updates' }}</h1>
    </div>
</section>
                ...
                <div class="news-list">
                    <div class="news-item">
                        ...
                        <div class="news-content-item">
                            ...
                            <p>We're excited to announce new professional development courses designed to enhance your skills and advance your career. Check out our <a href="{{ route('courses') }}">Courses</a> page for the full list.</p>
                        </div>
                    </div>

                    <div class="news-item">
                        <div class="news-date">
                            <span class="day">{{ date('d', strtotime('-5 days')) }}</span>
                            <span class="month">{{ date('M', strtotime('-5 days')) }}</span>
                        </div>
                        <div class="news-content-item">
                    ...
                    <div class="news-item">
                        <div class="news-date">
                            <span class="day">{{ date('d', strtotime('-10 days')) }}</span>
                            <span class="month">{{ date('M', strtotime('-10 days')) }}</span>
                        </div>
                        <div class="news-content-item">
