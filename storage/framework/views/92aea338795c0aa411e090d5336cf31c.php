...
<div class="page-header">
    <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 15px;">
        ...
        <div style="display: flex; gap: 10px;">
            ...
            <a href="<?php echo e(route('admin.question-pool.course', $course->id)); ?>" class="btn btn-secondary">
...
<div class="page-content">
    ...
    <div class="content-section">
        ...
        <div class="info-grid">
            ...
            <div class="info-item">
                ...
                <div class="info-value"><?php echo e($course->title); ?></div>
            </div>
            ...
            <div class="info-item">
                ...
                <div class="info-value">
                    <?php if($course->duration_hours): ?>
                        <?php echo e(number_format($course->duration_hours, 1)); ?> hours
                    <?php else: ?>
    ...
    <div class="stats-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px; margin: 30px 0;">
        <div class="stat-card">
            ...
            <div class="stat-info">
                ...
                <div class="stat-value"><?php echo e($course->total_questions); ?></div>
            </div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-info">
                ...
                <div class="stat-value"><?php echo e($course->enrolled_trainees); ?></div>
            </div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-info">
                ...
                <div class="stat-value"><?php echo e($course->total_results); ?></div>
            </div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-info">
                ...
                <div class="stat-value"><?php echo e($course->total_schedules); ?></div>
            </div>
        </div>
    </div>

    <!-- Recent Questions -->
    <?php if($course->questionPools->count() > 0): ?>
    <div class="content-section">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
            <h2 class="section-title">
                <i class="fas fa-question-circle"></i> Recent Questions
            </h2>
            <a href="<?php echo e(route('admin.question-pool.course', $course->id)); ?>" class="btn btn-secondary btn-sm">
                View All Questions
            </a>
        </div>
        
        <div class="questions-list">
            <?php $__currentLoopData = $course->questionPools->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="question-item">
                <div class="question-header">
                    <span class="question-number">Q<?php echo e($loop->iteration); ?></span>
                    <span class="question-points"><?php echo e($question->points); ?> point(s)</span>
                </div>
                ...
                <div class="question-options">
                    ...
                    <div class="option-item <?php echo e($key === $question->correct_answer ? 'correct' : ''); ?>">
                        <span class="option-key"><?php echo e($key); ?>.</span>
        ...
        <div class="table-container">
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?php echo e($result->trainee->full_name ?? $result->trainee->username); ?></td>
                        <td><?php echo e($result->score); ?> / <?php echo e($result->total_questions); ?></td>
                        <td><?php echo e(number_format($result->percentage, 1)); ?>%</td>
                        <td>
                            <span class="status-badge <?php echo e($result->status === 'Pass' ? 'status-active' : 'status-inactive'); ?>">
                                <?php echo e($result->status); ?>

                            </span>
                        </td>
                        <td><?php echo e($result->completed_at ? $result->completed_at->format('M d, Y H:i') : '-'); ?></td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tbody>
            </table>
    ...
    <!-- Enrolled Trainees -->
    <?php if($enrolledTrainees->count() > 0): ?>
    <div class="content-section">
        <h2 class="section-title">
        ...
        <div class="table-container">
            <table class="data-table">
                ...
                <tbody>
                    <?php $__currentLoopData = $enrolledTrainees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trainee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><?php echo e($trainee->pivot->granted_at ? $trainee->pivot->granted_at->format('M d, Y') : '-'); ?></td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tbody>
            </table>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO LEGION\Documents\leveler\resources\views/admin/courses/show.blade.php ENDPATH**/ ?>