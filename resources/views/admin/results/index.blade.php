...
<div class="page-content">
    ...
    <div class="content-section" style="margin-bottom: 20px;">
        <form method="GET" action="{{ route('admin.results.index') }}" class="filters-form">
    ...
    <div class="content-section">
        ...
        <div class="table-header" style="margin-bottom: 15px;">
            <strong>Showing {{ $results->firstItem() }} - {{ $results->lastItem() }} of {{ $results->total() }} results</strong>
        </div>
            ...
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="font-weight: 600; color: #333;">{{ $result->trainee->full_name }}</div>
                            <small style="color: #666;">{{ $result->trainee->username }}</small>
                        </td>
                        <td>
                            <div style="font-weight: 600; color: #333;">{{ $result->course->code }}</div>
                        ...
                        <td>
                            <div style="font-weight: 600; font-size: 16px; color: {{ $result->percentage >= 50 ? '#10b981' : '#ef4444' }};">
                        ...
                        <td class="actions-cell">
                            <a href="{{ route('admin.results.show', $result->id) }}" class="action-btn" title="View Details">
