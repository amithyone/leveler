        ...
        <div class="warning-text">
            ...
            <div class="payment-status">
                ...
                <div class="status-item">
                    ...
                    <span class="value">₦{{ number_format($totalRequired, 2) }}</span>
                </div>
                <div class="status-item">
                ...
                <div class="progress-bar">
                    <div class="progress-fill" style="width: {{ $trainee->getPaymentProgress() }}%"></div>
                </div>
                <p class="progress-text">{{ number_format($trainee->getPaymentProgress(), 1) }}% Paid</p>
            </div>
            <a href="{{ route('trainee.payments.create') }}" class="btn btn-primary">
...
<div class="certificates-grid">
    ...
    <div class="certificate-card">
        ...
        <div class="certificate-content">
            ...
            <p class="certificate-code">{{ $certificate->course->code }}</p>
            <div class="certificate-meta">
                <span><i class="fas fa-calendar"></i> {{ $certificate->completed_at->format('F d, Y') }}</span>
                <span><i class="fas fa-percentage"></i> Score: {{ number_format($certificate->percentage, 1) }}%</span>
            </div>
        </div>
        <div class="certificate-actions">
            <a href="{{ route('trainee.certificates.view', $certificate->id) }}" class="btn btn-primary btn-sm">
                <i class="fas fa-eye"></i> View
            </a>
            <a href="{{ route('trainee.certificates.download', $certificate->id) }}" class="btn btn-outline btn-sm">
...
<div class="empty-state">
    ...
    <a href="{{ route('trainee.courses.index') }}" class="btn btn-primary">
