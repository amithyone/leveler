...
<?php $__env->startSection('title', 'e-Learning - Leveler'); ?>

<?php $__env->startSection('content'); ?>
<section class="page-header">
    <div class="container">
        <h1><?php echo e($page->title ?? 'e-Learning Platform'); ?></h1>
    </div>
</section>
            ...
            <div class="elearning-content">
                ...
                <div class="cta-section" style="text-align: center; margin-top: 50px; padding: 40px; background: #f8f9fa; border-radius: 12px;">
                    ...
                    <div style="display: flex; gap: 15px; justify-content: center; flex-wrap: wrap;">
                        <a href="<?php echo e(route('register')); ?>" class="btn btn-primary">Register Now</a>
                        <a href="<?php echo e(route('trainee.login')); ?>" class="btn btn-secondary">Trainee Login</a>
                    </div>
                </div>
            </div>
        <?php endif; ?>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO LEGION\Documents\leveler\resources\views/frontend/e-learning.blade.php ENDPATH**/ ?>