<?php $__env->startSection('title', 'Home - Leveler'); ?>

<?php $__env->startSection('content'); ?>
<section class="hero">
    <div class="hero-slider">
        <?php if($page && $page->slider_images && count($page->slider_images) > 0): ?>
            ...
            <div class="hero-slide <?php echo e($index === 0 ? 'active' : ''); ?>" style="background-image: url('<?php echo e(\Illuminate\Support\Facades\Storage::url($sliderImage)); ?>');">
...
<section class="vulnerability-section">
    <div class="container">
        ...
        <a href="<?php echo e(route('contact')); ?>" class="btn btn-primary">Reach Out</a>
    </div>
</section>
    ...
    <div class="container">
        <div class="about-content">
            <div class="about-text">
                ...
                <a href="<?php echo e(route('about')); ?>" class="btn btn-primary">Know More</a>
            </div>
        </div>
    </div>
</section>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO LEGION\Documents\leveler\resources\views/frontend/home.blade.php ENDPATH**/ ?>