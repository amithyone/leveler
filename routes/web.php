...
Route::get('/trainee/register', [TraineeRegisterController::class, 'showRegistrationForm'])->name('trainee.register');
Route::post('/trainee/register', [TraineeRegisterController::class, 'register']);
