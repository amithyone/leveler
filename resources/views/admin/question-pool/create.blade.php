        ...
        <form action="{{ route('admin.question-pool.store') }}" method="POST" id="questionForm">
            ...
            <div id="essayOptions" style="display: {{ old('type') === 'essay' ? 'block' : 'none' }};">
                <div class="form-group">
                    ...
                    <textarea name="correct_answer" id="correct_answer_essay" rows="6" class="form-control" placeholder="Enter key points or expected answer for essay questions" required>{{ old('correct_answer') }}</textarea>
