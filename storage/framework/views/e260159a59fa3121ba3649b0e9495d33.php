...
<div class="section">
    ...
    <div class="payment-form-card">
        ...
        <form method="POST" action="<?php echo e(route('trainee.payments.store')); ?>" id="payment-form">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-actions">
                ...
                <a href="<?php echo e(route('trainee.payments.index')); ?>" class="btn btn-secondary">
...
<?php echo $__env->make('layouts.trainee', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LENOVO LEGION\Documents\leveler\resources\views/trainee/payments/create.blade.php ENDPATH**/ ?>